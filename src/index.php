...
<!-- W3CSS(Google fonts, Font awesome) -->
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">

<!-- Font awesome, google fonts at the end. -->
	...
	<div class="w3-display-middle" style="white-space:nowrap;">
		<div class="p-border w3-display-middle w3-padding-large w3-border
			...
			<h1 class="w3-hide-small w3-xxxlarge">
				LORENZO BALDINI<span class="p-text">.</span>
			</h1>
			<h5 class="w3-hide-medium w3-hide-large w3-xlarge"
			...
			<h2><span id="typed"></span><span class="p-text">.</span></h2>
		</div>
	</div>
</div>
...
<div class="spannerWh spanner-2 w3-card w3-content w3-container" id="about">
	<div class="w3-container w3-half">
		<div class="w3-container w3-half">
				<img src="/images/me_150x150-c.jpeg" alt="me" />
		</div>
		<div class="w3-container w3-half">
			<p>Lorenzo Baldini</p>
			<p>L.Baldini@sms.ed.ac.uk</p>
			<p>Cagliari, Italy</p>
		</div>
		<div class="w3-container">
			<p>Haskell:<span class="w3-right">85</span></p>
			<div class="progress-bar-bg">
				<div class="progress-bar-main" style="width:85%"></div>
			</div>
			<p>Python:<span class="w3-right">70</span></p>
			<div class="progress-bar-bg">
				<div class="progress-bar-main" style="width:70%"></div>
			</div>
			<p>Frontend:<span class="w3-right">65</span></p>
			<div class="progress-bar-bg">
				<div class="progress-bar-main" style="width:65%"></div>
			</div>
			<p>Backend:<span class="w3-right">55</span></p>
			<div class="progress-bar-bg">
				<div class="progress-bar-main" style="width:55%"></div>
			</div>
		</div>
	</div>
	<div class="w3-container w3-half w3-justify">
		<h3 class="">About me</h3>
		<p>A lot of waffle that I promise I'll write bla bla. Lorem Ipsum is
...
<div class="spannerBg spanner-3 w3-card w3-container">
	<div class="w3-row w3-center w3-content">
		...
		<div class="w3-quarter stats">
			<i class="fas fa-graduation-cap w3-xxxlarge"></i>
			<h1 class="stats-counter">1<sup>st</sup></h1>
			<h2>Predicted degree</b></h2>
		</div>
		<div class="w3-quarter stats">
			<i class="fas fa-code w3-xxxlarge"></i>
			<h1 class="stats-counter">3</h1>
			<h2>Hackathons</b></h2>
		</div>
		<div class="w3-quarter stats">
...
<div class="spannerWh spanner-4 w3-container w3-content" id="cv">
	<div class="timeline">
		<div class="container left">
			<div class="content">
				<h3>University of Edinburgh
					<span class="w3-right w3-large">2018-Now</span>
				</h3>
				<p>BSc in Computer Science. Focusing on proofs, logic and
					functional programming.<br>
					Predicted 1<sup>st</sup>.</p>
			</div>
		</div>
		<div class="container right">
			<div class="content">
				<h3>UWC Atlantic College
					<span class="w3-right w3-large">2016-2018</span>
				</h3>
				<p>>UWC makes education a force to unite people, nations
					and cultures for peace and a sustainable future.<br>
					IB with 766 in Physics, Further Mathematics and HL
					Mathematics.<br>
					<b>Tutored</b> Mathematics, programming and system
					design.</p>
			</div>
		</div>
		<div class="container left">
				<div class="content">
					...
					<p>BSc in Computer Science. Focusing on proofs, logic and
						functional programming. Predicted 1<sup>st</sup>.</p>
				</div>
			</div>
			<div class="container right">
				<div class="content">
					...
					<p>IB with 766 in Physics, Further Mathematics and HL
						Mathematics</p>
				</div>
			</div>
	</div>
