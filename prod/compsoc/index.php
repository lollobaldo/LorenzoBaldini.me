<!DOCTYPE html>
<html lang="en-GB">
<title>Lorenzo 4 SocSec</title>

<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="apple-mobile-web-app-title" content="Lorenzo 4 SocSec">
...
<link rel="stylesheet" href="/css/compsoc_index.css" />
<!-- endbuild -->
	...
	<div class="w3-display-middle" style="white-space:nowrap;">
		<div class="p-border w3-display-middle w3-padding-large w3-border
			...
			<h1 class="w3-hide-small w3-xxxlarge">
				LORENZO 4 SOCIAL SEC<span class="p-text">.</span>
			</h1>
			...
			<div id="typed-strings">
				<p><i class="p-text fas fa-pizza-slice"></i> Pizza</p>
				<p><i class="p-text fas fa-beer"></i> Pub quizzes</p>
				<p><i class="p-text fas fa-pizza-slice"></i> More pizza</p>
